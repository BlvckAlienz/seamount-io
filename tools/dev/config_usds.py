...
class Settings(BaseSettings):
    ...
    SUPPORTED_ASSETS: Dict[str, Dict[str, Any]] = {
        "USDT": {
            ...
            "decimals": 6,
            "is_stable": True,
            "fee_tier": "stablecoin",  # For fee calculations
        },
        "USDCa": {
            "asset_id": 31566704,
        ...
        "goBTC": {
            ...
            "decimals": 8,
            "is_stable": False,
            "fee_tier": "premium",  # Higher fee tier for volatile assets
            "oracle_symbol": "BTC",  # For price feeds
        },
        "goETH": {
            "asset_id": 386195940,
    ...
    # Define our fee structure based on 'seamount_business_case.md'
    FEE_STRUCTURE: Dict[str, float] = {
        "on_ramp": 0.025,  # 2.5% FX spread for fiat-to-crypto
        "swap_stablecoin": 0.008,  # 0.8% for stable/stable swaps
        "swap_premium": 0.01,  # 1.0% for swaps involving BTC/ETH
        "p2p_stablecoin": 0.008,
        "p2p_premium": 0.01,
    }
