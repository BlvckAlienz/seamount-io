        ...
        <div className="p-4 md:p-6">
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-gray-400 mb-2">No Active Collateral</h3>
              <p className="text-gray-500">You don't have any locked collateral positions</p>
            </div>
          ) : (
