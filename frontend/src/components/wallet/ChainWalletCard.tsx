...
const ChainWalletCard: React.FC<ChainWalletCardProps> = ({ 
  ...
  return (
    ...
    >
      {/* Tron Preferred Badge - positioned above card */}
      {chain === 'tron' && status === 'created' && (
        <div className="absolute -top-3 -right-3 z-20 flex items-center gap-1 px-2 py-1 bg-gradient-to-r from-purple-600 to-cyan-600 rounded-full text-[10px] font-bold text-white border-2 border-cyan-400 shadow-lg shadow-cyan-500/20">
