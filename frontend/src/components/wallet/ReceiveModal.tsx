...
const ReceiveModal: React.FC<ReceiveModalProps> = ({ 
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-gray-900 rounded-xl sm:rounded-2xl max-w-md w-full max-h-[95vh] sm:max-h-[90vh] overflow-y-auto p-4 sm:p-6 md:p-8 border border-gray-200 dark:border-gray-700 shadow-2xl animate-in zoom-in-95 duration-200">
        {/* ========== HEADER ========== */}
        <div className="flex items-center justify-between mb-4 sm:mb-6">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="min-w-0">
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 dark:text-white truncate">Receive Assets</h2>
              <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 truncate">On {chainConfig?.name}</p>
            </div>
          </div>
          <button
            onClick={onClose}
            className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors text-gray-400 hover:text-gray-700 dark:hover:text-white"
          >
            <X className="h-5 w-5" />
          </button>
        </div>
        ...
        <div className="mb-4 sm:mb-6">
          <Label className="text-xs sm:text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2 block">Select Blockchain</Label>
          <Select value={selectedChain} onValueChange={setSelectedChain}>
            <SelectTrigger className="bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white h-10 sm:h-12 text-sm sm:text-base">
              <SelectValue />
            </SelectTrigger>
        ...
        {walletAddress ? (
          <>
            ...
            {/* ========== ADDRESS DISPLAY ========== */}
            <div className="bg-gray-50 dark:bg-gray-800/50 rounded-lg sm:rounded-xl p-3 sm:p-4 mb-3 sm:mb-4 border border-gray-200 dark:border-gray-700">
              <p className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 mb-1 sm:mb-2">
                Your {chainConfig?.name} Address
              </p>
              <p className="text-gray-800 dark:text-white font-mono text-[10px] sm:text-xs md:text-sm break-all leading-relaxed">
                {walletAddress}
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3 mb-3 sm:mb-4">
              ...
              <button
                ...
                className="flex flex-col items-center justify-center gap-1 sm:gap-2 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-white py-2 sm:py-3 rounded-lg sm:rounded-xl font-medium transition-colors"
              >
            ...
            {chainConfig?.explorer && walletAddress && (
              <a
                ...
                className="flex items-center justify-center gap-1 sm:gap-2 text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 text-xs sm:text-sm transition-colors py-2 mb-3"
              >
            ...
            <div className="mt-3 sm:mt-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-500/30 rounded-lg p-2 sm:p-3">
              <p className="text-blue-700 dark:text-blue-300 text-[10px] sm:text-xs text-center leading-relaxed">
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 font-semibold mb-2">No {chainConfig?.name} Wallet Found</p>
            <p className="text-sm text-gray-500 dark:text-gray-500 mb-4">Create a {chainConfig?.name} wallet to receive funds</p>
            <button
              onClick={() => {
                onClose();
