    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-2 sm:p-4">
      <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl max-w-6xl w-full max-h-[92vh] overflow-hidden border border-blue-500/30 shadow-2xl">
        ...
        <div className="flex flex-col lg:flex-row h-[calc(92vh-100px)]">
          {/* Main Content - NOW ON LEFT for desktop, TOP for mobile */}
          <div className="flex-1 p-3 sm:p-6 overflow-auto bg-gray-900/50 order-2 lg:order-1">
          ...
          {/* Sidebar - Asset Selection - NOW ON RIGHT for desktop, COLLAPSIBLE for mobile */}
          <div className={`
            lg:w-80 border-gray-700 p-3 sm:p-6 overflow-auto bg-gray-800/50
            transition-all duration-300 ease-in-out
            ${showAssetList 
              ? 'max-h-96 lg:max-h-full border-t lg:border-l lg:border-t-0 order-1 lg:order-2' 
              : 'max-h-0 lg:max-h-full border-0 lg:border-l lg:border-t-0 overflow-hidden order-1 lg:order-2'
            }
          `}>
                ...
                return (
                  <button
                    ...
                    onClick={() => {
                      ...
                      // Auto-collapse asset list on mobile when asset is selected
