...
import { X, Shield, AlertTriangle, TrendingUp, Target, RefreshCw } from 'lucide-react';
      ...
      <div className="bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700 rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto mx-2 sm:mx-4">
        ...
        <div className="flex items-center justify-between p-4 md:p-6 border-b border-gray-700">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">View and manage locked assets</p>
          </div>
          <button
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 md:gap-4 mb-6">
                <div className="bg-gradient-to-br from-orange-900/20 to-yellow-900/20 border border-orange-500/30 rounded-xl p-3 md:p-4">
                ...
                <div className="bg-gradient-to-br from-green-900/20 to-emerald-900/20 border border-green-500/30 rounded-xl p-3 md:p-4">
                  <div className="flex items-center justify-between mb-2">
                ...
                <div className="bg-gradient-to-br from-blue-900/20 to-cyan-900/20 border border-blue-500/30 rounded-xl p-3 md:p-4">
                  <div className="flex items-center justify-between mb-2">
