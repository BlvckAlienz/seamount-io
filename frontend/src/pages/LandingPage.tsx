          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 mb-3 sm:mb-4 max-w-3xl mx-auto leading-relaxed px-4">
                Build real wealth with digital currencies. <strong className="text-indigo-600">Earn 5.25-8.20% net yearly returns and trade outcomes of real-life events.</strong> Send money instantly anywhere in the world.
              </p>
