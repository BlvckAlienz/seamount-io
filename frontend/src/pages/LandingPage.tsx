        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3">
          <div className="flex items-center justify-between">
            <a href="/" className="flex items-center space-x-3">
              <img src="https://i.imgur.com/59eVKha.png" alt="Seamount Logo" className="w-10 h-10 object-contain filter drop-shadow-lg rounded-md" />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-sm text-gray-400">
                <div className="flex items-center"><Shield className="h-4 w-4 mr-1.5 text-green-400" /><span>Bank-level security</span></div>
                <div className="flex items-center"><Zap className="h-4 w-4 mr-1.5 text-yellow-400" /><span>Sub-second settlements</span></div>
                <div className="flex items-center"><DollarSign className="h-4 w-4 mr-1.5 text-blue-400" /><span>Up to 87% lower fees</span></div>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-center">
                    <div className="lg:col-span-3 bg-gradient-to-br from-blue-900/30 to-blue-800/10 rounded-xl p-8 border border-blue-700/30 backdrop-blur-sm fade-in">
                        <h3 className="text-2xl font-bold mb-6 text-blue-300">1:1 USD Peg & Transparency</h3>
                        ...
                        <ul className="space-y-3 text-gray-300">
                            {[ "Fully backed by audited USD reserves", "Regulated and compliant across jurisdictions", "Regular public attestations ensure transparency", "Instant settlement on the Algorand network" ].map((feature, i) => (
                                <li key={i} className="flex items-start"><Check className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" /><span>{feature}</span></li>
                            ))}
                        </ul>
                    </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <select id="stake-period" name="stake-period" value={stakePeriod} onChange={(e) => setStakePeriod(e.target.value)} className="w-full mt-1 px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white">
                                    ...
                                    <option value="365">1 Year (4.5% APY)</option>
                                </select>
                            </div>
                            <div className="bg-gradient-to-r from-green-600 to-teal-600 rounded-lg p-4 text-center">
                                <div className="text-2xl font-bold">{rewards}</div>
                                <div className="text-sm opacity-80">Estimated Annual Yield</div>
                            </div>
                        </div>
                    </div>
                </div>
              ...
              <div className="space-y-6 fade-in">
                 {[
                  ...
                  { icon: <Phone className="h-6 w-6 text-purple-500 flex-shrink-0 mt-1" />, title: "Call Us", detail: "+254 751 875 374" }
                    ...
                    <div key={i} className="flex items-start space-x-4"><div className="p-3 bg-gray-800/50 rounded-full">{item.icon}</div><div><h3 className="font-semibold text-lg text-white mb-1">{item.title}</h3><p className="text-gray-300">{item.detail}</p></div></div>
                ))}
              </div>
              <div className="fade-in">
