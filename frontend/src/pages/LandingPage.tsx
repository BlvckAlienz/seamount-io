        ...
        <section className="relative py-20 md:py-32 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
            <div className="text-center max-w-4xl mx-auto">
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 bg-gradient-to-r from-blue-400 via-white to-purple-300 bg-clip-text text-transparent tracking-tighter">Borderless Money for People & SMBs</h1>
              <p className="text-lg sm:text-xl text-gray-300 mb-10 leading-relaxed">Experience instant, low-cost P2P transfers and power your business with programmable, 24/7 financial infrastructure. Built for the dynamic realities of emerging African markets.</p>
