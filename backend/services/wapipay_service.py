...
class WapiPayService:
    ...
    async def validate_account(
        ...
        body = {
            ...
            "callBackUrl":            callback_url or "https://seamount-main.onrender.com/webhooks/wapipay/payouts",
            "callBackFormat":         "JSON",
            "ccy":                    currency,
            "countryCode":            country,
        }
    ...
    async def create_virtual_account(
        ...
        body = {
            ...
            "email":                    user_email,
            "callBackUrl":              "https://seamount-main.onrender.com/webhooks/wapipay/collections",
            "callBackFormat":           "JSON",
            "ccy":                      "NGN",
            "countryCode":              "NG",
        }
