...
# ADD THIS METHOD to DatabaseService class after get_user_wallet() method
    ...
    async def execute_query(self, query: str, params: Any = None) -> Optional[List[Dict[str, Any]]]:
        ...
        try:
            ...
            # For Supabase, we need to use the appropriate table methods
    ...
    async def _execute_select(self, query: str, params: tuple) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            if params and len(params) > 0:
                # Simple equality filter for first param
    ...
    async def _execute_update(self, query: str, params: tuple) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            # Extract update data and filter
            # This is simplified - enhance for production
            update_data = {}
    ...
    def _extract_table_name(self, query: str, operation: str) -> str:
        ...
        try:
            ...
            if operation == 'insert':
                ...
                # Extract from "SELECT * FROM table_name"
    ...
    async def log_event(self, event_type: str, event_data: Dict[str, Any]) -> bool:
        ...
        try:
            log_entry = {
                ...
                "details": event_data,  # ðŸš¨ CHANGED FROM event_data TO details
                "created_at": datetime.utcnow().isoformat()
            }
