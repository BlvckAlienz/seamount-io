...
# This script will run inside the Vercel build container.
# It will tell us the ground truth about the environment.
...
# Exit with a success code so we can see the full log.
exit 0